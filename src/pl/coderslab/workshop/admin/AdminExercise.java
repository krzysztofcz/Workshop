...
public class AdminExercise {
	...
	private static String nazwa = "Exercise";
	private static Exercise obiekt = new Exercise();
	private static Exercise[] listaObiektow = new Exercise[0];
	 ...
	 */
	private static Exercise obiektAdd(String[] pola,String[] wartosci) {
		for(int i=0;i<pola.length;i++) {
			try {
